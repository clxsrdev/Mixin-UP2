...
//                    .bold()
                ...
                ZStack {
                    ...
                    Text("In this level you have to get STAR")
                        .font(.title)
                        .bold()
                        .foregroundStyle(.black)
                        .padding(.horizontal)
                ...
                ZStack {
                    ...
                    ZStack {
                        ...
                        ZStack {
                            ...
                            +
                            Text("STARS ")
                                .foregroundColor(Color(UIColor(red: 1.00, green: 0.77, blue: 0.00, alpha: 1.00)))
                                .font(.custom("Futura-Bold", size: 20))
                            +
                            Text("are composed of ")
                                .foregroundColor(.black)
                                .font(.custom("Futura-Bold", size: 20))
                            +
                            Text("SPACE ")
...
struct Level8View_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return Level8View(level8: level8View.projectedValue)
    }
}
