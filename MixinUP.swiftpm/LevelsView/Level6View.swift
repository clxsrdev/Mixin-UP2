...
//                    .bold()
                ...
                ZStack {
                    ...
                    Text("In this level you have to get VOLCANO")
                        .font(.title)
                        .bold()
                        .foregroundStyle(.black)
                        .padding(.horizontal)
                ...
                ZStack {
                    ...
                    ZStack {
                        ...
                        ZStack {
                            ...
                            +
                            Text("VOLCANOES ")
                                .foregroundColor(Color(UIColor(red: 1.00, green: 0.49, blue: 0.31, alpha: 1.00)))
                                .font(.custom("Futura-Bold", size: 20))
                            +
                            Text("are often filled with ")
                                .foregroundColor(.black)
                                .font(.custom("Futura-Bold", size: 20))
                            +
                            Text("ROCKS")
...
struct Level6View_Previews: PreviewProvider {
    static var previews: some View {
        let level6View = State(initialValue: false)
        return Level6View(level6: level6View.projectedValue)
    }
}
