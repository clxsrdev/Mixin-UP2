...
//                    .bold()
                ...
                ZStack {
                    ...
                    Text("In this level you have to get FIRE")
                        .font(.title)
                        .bold()
                        .foregroundStyle(.black)
                        .padding(.horizontal)
...
struct Level4View_Previews: PreviewProvider {
    static var previews: some View {
        let level4View = State(initialValue: false)
        return Level4View(level4: level4View.projectedValue)
    }
}
