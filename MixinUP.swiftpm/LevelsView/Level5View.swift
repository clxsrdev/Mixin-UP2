...
//                    .bold()
                ...
                ZStack {
                    ...
                    Text("In this level you have to get HUMAN")
                        .font(.title)
                        .bold()
                        .foregroundStyle(.black)
                        .padding(.horizontal)
...
struct Level5View_Previews: PreviewProvider {
    static var previews: some View {
        let level5View = State(initialValue: false)
        return Level5View(level5: level5View.projectedValue)
    }
}
