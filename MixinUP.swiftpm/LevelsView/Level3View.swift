...
//                    .bold()
                ...
                ZStack {
                    ...
                    Text("In this level you have to get ENERGY")
                        .font(.title)
                        .bold()
                        .foregroundStyle(.black)
                        .padding(.horizontal)
                ...
                ZStack {
                    ...
                    ZStack {
                        ...
                        ZStack {
                            Text("Remember that one type of ")
                                .foregroundColor(.black)
                            ...
                            Text(" is wind energy, ")
                                ...
                                .font(.custom("Futura-Bold", size: 18))
                            +
                            Text("which is produced by the ")
                                .foregroundColor(.black)
                                .font(.custom("Futura-Bold", size: 18))
                            +
                            Text("AIR ")
                                .foregroundColor(Color(UIColor(red: 0.57, green: 0.79, blue: 1.00, alpha: 1.00)))
                                .font(.custom("Futura-Bold", size: 18))
                            +
                            Text("in the ")
                                .foregroundColor(.black)
...
struct Level3View_Previews: PreviewProvider {
    static var previews: some View {
        let level3View = State(initialValue: false)
        return Level3View(level3: level3View.projectedValue)
    }
}
