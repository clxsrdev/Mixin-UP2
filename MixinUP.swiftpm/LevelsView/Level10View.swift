...
struct Level10View: View {
    ...
    @Binding var level10: Bool
        ...
        @State private var timeRemaining = 210
                    ...
                    .gesture(
                        DragGesture()
                            .onChanged { value in
                                ...
                                let stoneFrame = CGRect(x: stonePosition.x - 45, y: stonePosition.y - 30, width: 90, height: 60)
                                let spaceFrame = CGRect(x: spacePosition.x - 45, y: spacePosition.y - 40, width: 90, height: 80)
                                let alienFrame = CGRect(x: alienPosition.x - 37.5, y: alienPosition.y - 40, width: 75, height: 80)
...
//                    .bold()
                ...
                ZStack {
                    ...
                    Text("In this level you have to get UFO")
                        .font(.title)
                        .bold()
                        .foregroundStyle(.black)
                        .padding(.horizontal)
                ...
                Image("ufoI")
                    .resizable()
                    .frame(width: info ? 300 : 160, height: info ? 300 : 160)
                ...
                ZStack {
                    ...
                    ZStack {
                        ...
                        ZStack {
                            ...
                            +
                            Text("UFOs ")
                                .foregroundColor(Color(UIColor(red: 0.24, green: 0.47, blue: 0.51, alpha: 1.00)))
                                .font(.custom("Futura-Bold", size: 20))
                            +
                            Text("are the ")
                                .foregroundColor(.black)
                            ...
                            +
                            Text("ALIENS ")
                                .foregroundColor(Color(UIColor(red: 0.18, green: 0.53, blue: 0.22, alpha: 1.00)))
                                .font(.custom("Futura-Bold", size: 20))
                            +
                            Text("use ")
                                .foregroundColor(.black)
...
struct Level10View_Previews: PreviewProvider {
    static var previews: some View {
        let level10View = State(initialValue: false)
        return Level10View(level10: level10View.projectedValue)
    }
}
