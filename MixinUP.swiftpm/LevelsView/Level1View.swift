...
//                .bold()
            ...
            ZStack {
                ...
                Text("In this level you have to get PLANT")
                    .font(.title)
                    .bold()
                    .foregroundStyle(.black)
                    .padding(.horizontal)
            ...
            ZStack {
                ...
                ZStack {
                    ...
                    ZStack {
                        Text("Remember that to generate ")
                            .foregroundColor(.black)
...
struct Level1View_Previews: PreviewProvider {
    static var previews: some View {
        let level1View = State(initialValue: false)
        return Level1View(level1: level1View.projectedValue)
    }
}
