...
//                    .bold()
                ...
                ZStack {
                    ...
                    Text("In this level you have to get METEORITE")
                        .font(.title)
                        .bold()
                        .foregroundStyle(.black)
                        .padding(.horizontal)
                ...
                ZStack {
                    ...
                    ZStack {
                        ...
                        ZStack {
                            ...
                            +
                            Text("METEORITES ")
                                .foregroundColor(Color(UIColor(red: 0.02, green: 0.00, blue: 0.41, alpha: 1.00)))
                                .font(.custom("Futura-Bold", size: 20))
                            +
                            Text("are ")
                                .foregroundColor(.black)
                            ...
                            +
                            Text("ROCKS")
                                .foregroundColor(Color(UIColor(red: 0.00, green: 0.18, blue: 0.06, alpha: 1.00)))
                                .font(.custom("Futura-Bold", size: 20))
                            +
                            Text(".")
                                .foregroundColor(.black)
...
struct Level7View_Previews: PreviewProvider {
    static var previews: some View {
        let level7View = State(initialValue: false)
        return Level7View(level7: level7View.projectedValue)
    }
}
