...
//                    .bold()
                ...
                ZStack {
                    ...
                    Text("In this level you have to get ALIEN")
                        .font(.title)
                        .bold()
                        .foregroundStyle(.black)
                        .padding(.horizontal)
                ...
                ZStack {
                    ...
                    ZStack {
                        ...
                        ZStack {
                            ...
                            +
                            Text("SPACE")
                                .foregroundColor(Color(UIColor(red: 0.53, green: 0.24, blue: 0.98, alpha: 1.00)))
                                .font(.custom("Futura-Bold", size: 20))
                            +
                            Text(".")
                                .foregroundColor(.black)
...
struct Level9View_Previews: PreviewProvider {
    static var previews: some View {
        let level9View = State(initialValue: false)
        return Level9View(level9: level9View.projectedValue)
    }
}
